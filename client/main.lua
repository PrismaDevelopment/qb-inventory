...
local function ToggleHotbar(toggle)
    if toggle then ExecuteCommand('nakit') end
    local HotbarItems = {
...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    ...
    local name = PlayerData.charinfo.firstname..' '..PlayerData.charinfo.lastname..'-'..PlayerData.source
...
RegisterNUICallback('OpenJewelery', function()
    closeInventory()
    Wait(100)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", tostring("Player_Jewelery_"..PlayerData.citizenid), {
        maxweight = 30000,
        slots = 6,
    })
    TriggerEvent("inventory:client:SetCurrentStash", tostring("Player_Jewelery_"..PlayerData.citizenid))
end)
...
RegisterNUICallback("SetInventoryData", function(data, cb)
    print(data.fromSlot, data.toSlot, data.fromAmount, data.toAmount)
...
--#endregion Threads
exports('GetItemConfig', function()
	return QBItems
end)