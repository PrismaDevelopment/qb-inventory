    ...
    $.post(
        ...
        function(data) {
            ...
            $(".weapon-attachments-container-details").html(
                '<span style="font-weight: bold; letter-spacing: .1vh;">Silah ID\'si</span><br> ' +
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-line").html(
                ...
                "</span></p><p>First Name: <span>" +
                itemData.info.firstname +
                "</span></p><p>Last Name: <span>" +
                itemData.info.lastname +
                "</span></p><p>Birth Date: <span>" +
                itemData.info.birthdate +
                "</span></p><p>Gender: <span>" +
                gender +
                "</span></p><p>Nationality: <span>" +
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-line").html(
                    ...
                    itemData.amount +
                    "</p>" +
                    "<p><b>Silah ID\'si:</b> <span>" +
                    itemData.info.serie +
                    "</span></p><p><b>Silahtaki Mermi Sayısı:</b> <span>" +
                    itemData.info.ammo +
                    "</span></p><p><b>Sliahtaki Eklentiler</b>: <span>" +
                    attachmentString +
                    "</span></p>"
                );
            } else {
                ...
                $(".item-info-line").html(                    
                    ...
                    itemData.info.ammo +
                    "</span></p>" + 
                    "</span></p><p><b>Sliahtaki Eklentiler</b>: <span></span></p>"
                );
            }
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-line").html(
                    ...
                    itemData.amount +
                    "</p>" +
                    "<p>Evidence material: <span>" +
                    itemData.info.label +
                    "</span></p><p>Type number: <span>" +
                    itemData.info.ammotype +
                    "</span></p><p>Caliber: <span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><b>Silah ID\'si:</b> <span>" +
                    itemData.info.serie +
                    "</span></p><p>Crime scene: <span>" +
                ...
                $(".item-info-line").html(
                    ...
                    "<p>Evidence material: <span>" +
                    itemData.info.label +
                    "</span></p><p>Blood type: <span>" +
                    itemData.info.bloodtype +
                    "</span></p><p>DNA Code: <span>" +
            ...
            $(".item-info-line").html(
                ...
                itemData.amount +
                "</p>" +
                '<p>Card Holder: <span>' + itemData.info.name + '</span></p><p>Citizen ID: <span>' + itemData.info.citizenid + '</span></p><p>Card Number: <span>' + cardNumber + '</span></p>');			
            ...
            $(".item-info-line").html(
                ...
                itemData.amount +
                "</p>" +
                "<p> Quality: " + itemData.info.quality + "</p>");
        }
    } else {
        $(".item-info-title").html("<p>" + itemData.label + "</p>");
        $(".item-info-description").html("<p>" + itemData.description + "</p>")
        ...
        start: function(event, ui) {
            ...
            if (dragAmount == 0) {
                if (itemData.price != null) {
                    $(this).find(".item-slot-amount p").html("0 (0.00)");
                    ...
                    $(".ui-draggable-dragging")
                        ...
                        .html(
                            itemData.amount +
                            " (" +
                            ((itemData.weight * itemData.amount) / 1000).toFixed(2) +
                            ")"
                        );
                    $(".ui-draggable-dragging").find(".item-slot-key").remove();
                    if ($(this).parent().attr("data-inventory") == "hotbar") {
                ...
                if (itemData.price != null) {
                    ...
                    $(".ui-draggable-dragging")
                        ...
                        .html(
                            dragAmount +
                            " (" +
                            ((itemData.weight * dragAmount) / 1000).toFixed(2) +
                            ")"
                        );
                    $(".ui-draggable-dragging").find(".item-slot-key").remove();
                    if ($(this).parent().attr("data-inventory") == "hotbar") {
...
$(document).on("click", "#jewelery", function(e) {
    if (jewel) {return}
    jewel = true;
    e.preventDefault();
    $.post( "https://qb-inventory/OpenJewelery");
});
    ...
    if ($toSlot < 7) {
        $toInv
            ...
            .html(
                ...
                fromData.amount +
                " (" +
                ((fromData.weight * fromData.amount) / 1000).toFixed(2) +
                ')</p></div><div class="item-slot-label"><p>' +
                fromData.label +
                "</p></div>"
            );
    ...
    if ($fromSlot < 7) {
        $fromInv
            ...
            .html(
                ...
                toData.amount +
                " (" +
                ((toData.weight * toData.amount) / 1000).toFixed(2) +
                ')</p></div><div class="item-slot-label"><p>' +
                toData.label +
                "</p></div>"
            );
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (otherinventory.startsWith("stash-player_jewelery")) {
        // if (!fromData.name.startsWith('weapon_')) {
            console.log(fromData.type)
        if (!fromData.type != 'jewel') {
            InventoryError($fromInv, $fromSlot);
            return;
        }
    }
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if ((toData != undefined || toData != null) && toData.name == fromData.name && !fromData.unique) {
            ...
            // if (fromData.info.quality != toData.info.quality || fromData.info.date != toData.info.date) {
                ...
                // if (newData.name.split("_")[0] == "weapon") {
                    // if (!Inventory.IsWeaponBlocked(newData.name)) {
                        ...
                        if (newData.info.quality == 0) {
                            ...
                            .find("p")
                            .html("%"+Number(qualityLabel).toFixed(1));
                        }
                    // }
                // }
                ...
                if ($toSlot < 7 && $toInv.attr("data-inventory") == "player") {
                    $toInv
                        ...
                        .html(
                            ...
                            newDataTo.amount +
                            " (" +
                            ((newDataTo.weight * newDataTo.amount) / 1000).toFixed(2) +
                            ")</p></div>" +
                            ItemLabel
                        );
                } else if ($toSlot == 41 && $toInv.attr("data-inventory") == "player") {
...
(() => {
    ...
    Inventory.Open = function(data) {
        ...
        if (data.other != null && data.other != "") {
            ...
            $(".other-inventory .item-slot").css({
                "background-color": "rgba(83, 0, 0, 0.16)",
            });
        }
                    ...
                    if (item.slot < 7) {
                        ...
                        $(".player-inventory")
                            ...
                            .html(
                                ...
                                item.amount +
                                " (" +
                                ((item.weight * item.amount) / 1000).toFixed(2) +
                                ")</p></div>" +
                                ItemLabel
                            );
                        $(".player-inventory")
    ...
    Inventory.ToggleHotbar = function(data) {
        if (data.open) {
            ...
            var elem =
                '<div class="z-hotbar-item-slot" data-zhotbarslot="41"> <div class="z-hotbar-item-slot-key"><p>6</p></div><div class="z-hotbar-item-slot-img"></div><div class="z-hotbar-item-slot-label"><p>&nbsp;</p></div></div>';
            $(".z-hotbar-inventory").append(elem);
    ...
    Inventory.itemBox = function(data) {
        ...
        if (data.item.name.startsWith("weapon_")) {
            weapon = true
        }
        ...
        $itembox.html(
            ...
            data.item.label +
            '</p></div><div class="info-slot-img"><img src="images/' +
            data.item.image +
            '" alt="' +
            data.item.name +
            '" /></div>'
        ...
        window.addEventListener("message", function(event) {
            switch (event.data.action) {
                ...
                case "RobMoney":
                    ...
                    break;
                case "setName":
                        $("#player-inv-label").html(event.data.isim)
            }
        });
    };
})();
